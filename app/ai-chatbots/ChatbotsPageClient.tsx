...
import {
  ...
  Quote, ChevronDown, Headphones, Sparkles
} from 'lucide-react'
...
const customerSituations = [
  {
    quote: 'Ons supportteam is overbelast met steeds dezelfde vragen.',
    context: 'FAQ Automatisering',
    icon: MessageSquare
  },
  {
    quote: 'We missen leads omdat we niet snel genoeg kunnen reageren.',
    context: 'Lead Chatbot',
    icon: Target
  },
  {
    quote: 'Klanten verwachten 24/7 service maar we kunnen dat niet bieden.',
    context: '24/7 Chatbot',
    icon: Clock
  },
  {
    quote: 'Onze chat kost veel tijd maar levert weinig conversie op.',
    context: 'Intelligente Chatbot',
    icon: TrendingUp
  },
]
