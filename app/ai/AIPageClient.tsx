    ...
    <Link href={service.href} className="block h-full">
      <article className="glass-effect p-6 rounded-2xl h-full border border-primary-violet/20 hover:border-primary-violet/40 transition-all group cursor-pointer hover:scale-[1.02]">
        <div className="flex items-start justify-between mb-4">
          <div className="w-14 h-14 rounded-xl bg-primary-violet/10 flex items-center justify-center group-hover:scale-110 transition-transform">
            <service.icon className="w-7 h-7 text-primary-violet" />
          </div>
          <div className="text-right">
            <p className="text-2xl font-bold text-primary-emerald">{service.stat}</p>
            <p className="text-xs text-slate-400">{service.statLabel}</p>
          </div>
        </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-primary-violet/20 flex items-center justify-center">
                    <Bot className="w-5 h-5 text-primary-violet" />
                  </div>
                  <div>
                    <p className="text-xs text-slate-500">24/7 Beschikbaar</p>
                    <p className="text-lg font-bold text-slate-900">Altijd</p>
                  </div>
                </div>
              </m.div>
            </m.div>
            ...
            <div className="relative p-6 sm:p-10 rounded-2xl bg-gradient-to-br from-primary-violet/5 via-transparent to-primary-blue/5 border border-slate-200">
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-slate-500 leading-relaxed">
                  Als specialist in <strong className="text-slate-600">AI voor het MKB</strong> helpen wij bedrijven groeien met slimme automatisering.
                  Of u nu zoekt naar <strong className="text-slate-600">chatbot implementatie</strong>, efficiënte <strong className="text-slate-600">process automation (RPA)</strong>,
                  voorspellende <strong className="text-slate-600">AI analytics</strong> of een slimme <strong className="text-slate-600">virtuele assistent</strong> –
