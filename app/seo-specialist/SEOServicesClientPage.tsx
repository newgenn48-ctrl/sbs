            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500">Gemiddelde groei</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500">Gemiddelde positie</p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Hogere rankings</p>
                        <p className="text-sm text-slate-500">Top 10 posities voor uw keywords</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Meer organisch verkeer</p>
                        <p className="text-sm text-slate-500">Bezoekers zonder advertentiekosten</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Kwalitatieve leads</p>
                        <p className="text-sm text-slate-500">Bezoekers met koopintentie</p>
                      </div>
                    </div>
                  </div>
                </div>
