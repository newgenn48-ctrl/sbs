                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Voorspellende inzichten</p>
                        <p className="text-sm text-gray-400">Anticipeer op trends en kansen</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Concrete aanbevelingen</p>
                        <p className="text-sm text-gray-400">Geen abstracte data, maar acties</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Altijd actuele KPIs en metrics</p>
                      </div>
                    </div>
                  </div>
                </div>
