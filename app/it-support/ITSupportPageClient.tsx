            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <ScrollTrigger>
                <div className="relative rounded-2xl overflow-hidden border border-quantum-blue/20 shadow-2xl">
                  <Image
                    src="/IT Support.webp"
                    alt="IT Support specialist aan het werk"
                    width={1200}
                    height={800}
              ...
              <ScrollTrigger delay={0.2}>
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    IT-problemen? Wij <span className="text-gradient">lossen het op</span>
                  </h2>
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Van haperende computers tot complexe netwerkstoringen - ons team staat klaar om u te helpen. Snel, deskundig en zonder gedoe.
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Snelle responstijd</p>
                        <p className="text-sm text-gray-400">Meestal binnen 30 minuten</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Proactief beheer</p>
                        <p className="text-sm text-gray-400">Problemen voorkomen is beter</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Persoonlijk contact</p>
                        <p className="text-sm text-gray-400">Geen anonieme helpdesk</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
                  <span className="text-white">Uw IT, </span>
