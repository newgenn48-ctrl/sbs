...
import {
  ...
  Quote, ChevronDown, Users, RefreshCw,
...
const customerSituations = [
  {
    quote: 'We zijn uren kwijt aan het handmatig overzetten van data tussen systemen.',
    context: 'Data Synchronisatie',
    icon: Database
  },
  {
    quote: 'Facturen verwerken kost ons veel tijd en we maken regelmatig fouten.',
    context: 'Document Automatisering',
    icon: FileText
  },
  {
    quote: 'We vergeten regelmatig follow-ups en deadlines.',
    context: 'Workflow Automatisering',
    icon: Clock
  },
  {
    quote: 'Rapportages maken is een terugkerende tijdrovende klus.',
    context: 'Rapportage Automatisering',
    icon: Calculator
  },
]
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-quantum-purple/20 flex items-center justify-center">
                    <Cog className="w-5 h-5 text-quantum-purple" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Processen</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-quantum-purple/10 flex items-center justify-center flex-shrink-0">
                        <FileText className="w-5 h-5 text-quantum-purple" />
                      </div>
                      <div>
                        <p className="font-medium text-white">Document processing</p>
                        <p className="text-sm text-gray-400">Automatische verwerking</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-quantum-blue/10 flex items-center justify-center flex-shrink-0">
                        <Database className="w-5 h-5 text-quantum-blue" />
                      </div>
                      <div>
                        <p className="font-medium text-white">Data synchronisatie</p>
                        <p className="text-sm text-gray-400">Systemen altijd up-to-date</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Tijdsbesparing</p>
                        <p className="text-sm text-gray-400">Uren per week vrijmaken</p>
                      </div>
                    </div>
                  </div>
                </div>
