...
import {
  ...
  Target, Users, Settings, MessageSquare,
  Quote, ChevronDown, Headphones, Globe,
...
const customerSituations = [
  {
    quote: 'We missen veel telefoontjes omdat we in gesprek of onderweg zijn.',
    context: '24/7 Bereikbaarheid',
    icon: Phone
  },
  {
    quote: 'Het plannen van afspraken kost ons veel tijd door heen en weer mailen.',
    context: 'Automatische Planning',
    icon: Calendar
  },
  {
    quote: 'We kunnen niet alle bellers direct te woord staan tijdens drukke periodes.',
    context: 'Schaalbare Capaciteit',
    icon: Users
  },
  {
    quote: 'We hebben geen budget voor een fulltime receptionist.',
    context: 'Kostenefficiënt',
    icon: Zap
  },
]
