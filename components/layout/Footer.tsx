...
export default function Footer() {
  return (
    <footer className="relative bg-dark border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="tel:+31687874001" className="flex items-center gap-3 text-slate-400 hover:text-primary-blue transition-colors">
                <Phone className="h-4 w-4" />
                <span>06 87 87 40 01</span>
              </a>
              <a href="mailto:info@startbeheer.nl" className="flex items-center gap-3 text-slate-400 hover:text-primary-blue transition-colors">
          ...
          {[
            { title: 'IT Services', links: footerLinks.itServices },
            { title: 'Development', links: footerLinks.development },
            { title: 'Bedrijf', links: footerLinks.company },
            ...
            <div key={section.title}>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link href={link.href} className="text-slate-400 hover:text-primary-blue transition-colors text-sm">
                      {link.name}
                    </Link>
                  </li>
                ))}
